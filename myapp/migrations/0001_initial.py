# Generated by Django 4.1.4 on 2023-03-19 13:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('co1', models.CharField(default='', max_length=15)),
                ('co2', models.CharField(default='', max_length=15)),
                ('co3', models.CharField(default='', max_length=15)),
                ('co4', models.CharField(default='', max_length=15)),
                ('co5', models.CharField(default='', max_length=15)),
                ('tpl', models.CharField(default='Target Proficiency Level', max_length=50)),
                ('course_code', models.CharField(max_length=15)),
            ],
        ),
        migrations.CreateModel(
